...
<h1 style="text-align: center; color:brown">Analysis for Rui Fish</h1>

<div class="samepost clear">
<img src="img/rui.jpg" alt="post image"/>
...
$con = mysqli_connect("sql304.epizy.com", "epiz_22958723", "fMNsROvEhT0", "epiz_22958723_fishary");
	...
	SELECT id,  
	   ...
	   FROM sensorvalue,fixedvalue WHERE  id1=1 ORDER BY id DESC LIMIT 1
...
in the water willbe helpful to reduce Alkinity.</h3><br>";
				 }
			...
			if($value<=1 && $value>=0){
				echo "<h3> PH level:perfect.difference only   " .$value. " ph from reference value For Rui fish farming. </h3><br>";
				
			     }
			
			else if ($value<=2.5 && $value>1)
			echo "<h3> PH level:good but not perfect,you should Decress :  " .$value. " ph level For Rui fish farming. </h3><br>";
			
			else
			{
				echo "<h3 >PH level:Not usable at all, you should Decress :  " .$value. " ph level For Rui fish farming </h3><br>";
				...
				if($value<0 && $value>=-1){
				echo "<h3>PH level:perfect.difference only  " .$value*(-1). " ph from reference value For Rui fish farming </h3><br>";
			...
			echo "<h3>PH level:good but not perfect,you should increase :  " .$value*(-1). " ph level For Rui fish farming </h3><br>";
			
			else
			{
				echo "<h3 >PH level:Not usable at all, you should increase :  " .$value*(-1). " more ph level For Rui fish farming </h3><br>";
			...
			echo "<h3>Temperature level:good but not perfect,you should decress :  " .$value1. " degree celcious temperature For Rui fish farming  </h3><br>";
			
			else
			{
				echo "<h3 >Temperature level:Not usable at all you should Decress :  " .$value1. " degree celcious more temperature For Rui fish farming </h3><br>";
				...
				echo "<h3>Temperature level:perfect.difference only  " .$value1*(-1). " degree celcious from referance value For Rui fish farming </h3><br>";
			...
			echo "<h3>Temperature level:good but not perfect,you should increase : " .$value1*(-1). " degree celcious Temperature For Rui fish farming. </h3><br>";
			
			else
			{
				echo "<h3 >Temperature level:Not usable at all you should increase  " .$value1*(-1). " degree celcious more Temperature For Rui fish farming. </h3><br>";
			...
			if($value2<=80 && $value2>=0){
				echo "<h3>current CO level:perfect.difference only  " .$value2. " ppm from reference value For Rui fish farming.</h3><br>";
			...
			echo "<h3>current CO level:good but not perfect,you should decress :   " .$value2. " ppm co level For Rui fish farming.</h3><br>";
			
			else
			{
				echo "<h3 >current CO level:Not usable at all you should Decress :  " .$value2. " ppm co level more For Rui fish farming.</h3><br>";
				...
				echo "<h3>CO level:perfect.difference only  " .$value2*(-1). " ppm from reference value For Rui fish farming.</h3><br>";
			...
			echo "<h3>CO level:good but not perfect,you should increase :  " .$value2*(-1). " ppm more For Rui fish farming.</h3><br>";
			
			else
			{
				echo "<h3 >CO level:Not usable at all you should increase :  " .$value2*(-1). "ppm more co For Rui fish farming.</h3><br>";
			...
			if($value3<=0.02 && $value3>=0){
				echo "<h3>current Nh3 level:perfect,difference only  " .$value3. "ppm from reference value For Rui fish farming.</h3><br>";
			...
			echo "<h3>current NH3 level:good but not perfect,you should Decress :  ".$value3.  " ppm more nh3 For Rui fish farming.</h3><br>";
			
			}
			
			else
			{
				echo "<h3 >current Nh3 level:Not usable at all you should Decress :  " .$value3. " ppm more nh3 For Rui fish farming.</h3><br>";
				...
				echo "<h3>Nh3 level:perfect,difference only  " .$value3*(-1). " ppm nh3 For Rui fish farming.</h3><br>";
			...
			echo "<h3>NH3 level:good but not perfect,you should Add :  " .$value3*(-1). " ppm more nh3 For Rui fish farming.</h3><br>";
			
			else
			{
				echo "<h3 >Nh3 level:Not usable at all you should increase :  " .$value3*(-1). " ppm more nh3 For Rui fish farming.</h3><br>";
				...
				if($value7<=10 && $value7>=1){
			     ...
			     echo "<h3>Current  depth  " .$value7." feet . mortality rate significantly reduce at 9.5 feet depth cm depth</h3><br>";
			...
			if($value4<=1.5 && $value4>=0){
				echo "<h3>Depth level:perfect.difference from reference value only:  " .$value4. " feet For Rui fish farming. </h3><br>";
			...
			echo "<h3>Depth level:good but not perfect,you should Decress :  " .$value4. " feet more Depth For Rui fish farming.</h3><br>";
			
			else
			{
				echo "<h3 >Depth level:Not usable at all you should Decress :  ".$value4." feet more Depth For Rui fish farming.</h3><br>";
				...
				echo "<h3>Depth level:perfect.difference from reference value only:  " .$value4*(-1). " feet Depth For Rui fish farming.</h3><br>";
			...
			echo "<h3>Depth level:good but not perfect,you should  Add :  " .$value4*(-1). " feet more Depth For Rui fish farming.</h3><br>";
			
			else
			{
				echo "<h3 >Depth level:Not usable at all you should ADD :  " .$value4*(-1). " feet more Depth For Rui fish farming.</h3><br>";
			...
			if($value5<=2 && $value5>=0){
				echo "<h3> Turbidity level:perfect.difference only   " .$value5. " Ntu from reference value For Rui fish farming. </h3><br>";
			...
			else
			{
				...
				echo "<h3>Turbidity level:perfect.difference only  " .$value5*(-1). " Ntu from reference value For Rui fish farming.</h3><br>";
