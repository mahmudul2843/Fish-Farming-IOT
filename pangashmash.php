...
<h1 style="text-align: center; color:brown">Analysis for Pangash Fish</h1>

<div class="samepost clear">
<img src="img/pangash.jpg" alt="post image"/>
...
$con = mysqli_connect("sql304.epizy.com", "epiz_22958723", "fMNsROvEhT0", "epiz_22958723_fishary");
	...
	SELECT id,  
	   ...
	   FROM sensorvalue,fixedvalue WHERE  id1=3 ORDER BY id DESC LIMIT 1
